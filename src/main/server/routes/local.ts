...
import { deleteLocalScript, getAllLocalScripts, getLocalScript, getInstalledLocalScript, loadLocalScript, uploadLocalScript, getLocalScriptById } from "../scripts/local";
