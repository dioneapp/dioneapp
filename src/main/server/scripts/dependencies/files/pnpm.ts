...
export async function install(
	...
	const urls: Record<string, Record<string, string>> = {
		linux: {
			amd64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-linux-x64",
			arm64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-linux-arm64",
		},
		macos: {
			amd64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-macos-x64",
			arm64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-macos-arm64",
		},
		windows: {
			amd64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-win-x64.exe",
			arm64:
				"https://github.com/pnpm/pnpm/releases/download/v10.13.1/pnpm-win-arm64.exe",
		},
	};
	...
	const installerFile = fs.createWriteStream(
		path.join(depFolder, `pnpm.${installerExt}`),
	);
