...
export async function install(
	...
	const urls: Record<string, Record<string, string>> = {
		...
		macos: {
			amd64: "https://ollama.com/download/Ollama.dmg",
			arm64: "https://ollama.com/download/Ollama.dmg",
		},
		windows: {
			amd64: "https://ollama.com/download/ollama-windows-amd64.zip",
			arm64: "https://ollama.com/download/ollama-windows-arm64.zip",
		},
	};
	...
	const installerExt =
		platform === "windows" ? "zip" : platform === "macos" ? "dmg" : "tgz";
