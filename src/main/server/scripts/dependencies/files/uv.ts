...
export async function install(binFolder: string, id: string, io: Server): Promise<{success: boolean}> {
    ...
    const urls: Record<string, Record<string, string>> = {
        ...
        windows: {
            amd64: "https://github.com/astral-sh/uv/releases/download/0.8.3/uv-x86_64-pc-windows-msvc.zip",
            arm64: "https://github.com/astral-sh/uv/releases/download/0.8.3/uv-aarch64-pc-windows-msvc.zip",
