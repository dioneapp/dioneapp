...
export async function install(binFolder: string, id: string, io: Server): Promise<{success: boolean}> {
    ...
    const urls: Record<string, Record<string, string>> = {
        linux: {
            amd64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-linux-x64.tar.gz",
            arm64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-linux-arm64.tar.gz"
        },
        macos: {
            amd64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-darwin-x64.tar.gz",
            arm64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-darwin-arm64.tar.gz"
        },
        windows: {
            amd64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-win-x64.zip",
            arm64: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-win-arm64.zip",
            x86: "https://nodejs.org/download/release/latest-v22.x/node-v22.17.1-win-x86.zip"
        },
    }
