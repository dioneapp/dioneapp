            ...
            <div className="flex flex-col items-center justify-start h-full w-full p-4 z-50 px-6">
                <div className="w-full h-44 flex flex-col justify-center items-start gap-2">
                    ...
                    <div className="mt-2 w-full flex gap-2 px-0.5">
                        <button onClick={() => openLink("https://applio.org/discord")} className="text-xs w-full bg-white hover:bg-white/80 transition-colors duration-400 rounded-full text-black font-medium py-1 text-center">Discord</button>
                        <button onClick={() => openLink("https://github.com/dioneapp/dioneapp/issues")} className="text-xs w-full bg-white hover:bg-white/80 transition-colors duration-400 rounded-full text-black font-medium py-1">Report a bug</button>
                    </div>
