		...
		<div className="absolute inset-0 flex items-center justify-center bg-black/80 p-4 backdrop-blur-3xl" style={{zIndex: 80}}>
			{page === 0 && (
                ...
                <div className="flex justify-between w-full items-center">
                    ...
                    <button className="cursor-pointer z-50 flex items-center justify-center p-2 bg-white/10 hover:bg-white/20 rounded-full" type="button" onClick={() => set(null)}><Icon name="Close" className="h-3 w-3" /></button>
                </div>
                <div className="py-6 w-full h-full flex flex-col">
                    ...
                    <div className="mt-4 flex items-center justify-end">
                        <button onClick={install} type="button" className="flex items-center justify-center gap-2 p-4 text-xs bg-white hover:bg-white/80 transition-colors duration-400 rounded-full text-black font-semibold py-1 text-center cursor-pointer">Install</button>
                    </div>
                </div>
                </div> 
            )}
