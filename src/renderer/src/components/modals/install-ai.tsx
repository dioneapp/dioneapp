import { ArrowRight, ChevronLeft, Cpu, Loader2, ShieldCheck, Sparkles } from "lucide-react";
import Icon from "../icons/icon";
import ProgressBar from "../common/progress-bar";
import { Dispatch, SetStateAction } from "react";

export function InstallAIModal({ installStep, setInstallStep, ollamaStatus, logs, downloadOllama }: { installStep: number, setInstallStep: Dispatch<SetStateAction<number>>, ollamaStatus: string, logs: Record<string, string[]>, downloadOllama: () => void }) {
    return (
