...
export default function LogsComponent({ statusLog, logs, copyLogsToClipboard }: LogsProps) {
    return (
        <motion.div
            className="flex flex-col w-full h-full min-w-96 max-w-2xl justify-center items-center"
            key="logs"
        ...
        >
            <div className="w-full justify-end flex items-end mx-auto">
            ...
            <motion.div
                className="p-6 rounded-tl-xl rounded-b-xl border-tl-0 border border-white/10 shadow-lg relative overflow-hidden w-full backdrop-blur-md"
            >
