				...
				<div className="flex flex-col items-center justify-center h-full w-full max-w-screen-lg">
					...
					<div className="w-full h-44 max-w-xl min-w-xl truncate mt-12 mb-2">
						<button
							...
							className="focus:outline-none focus:ring-0 px-4 cursor-pointer active:scale-[0.97] w-full h-full bg-white/10 hover:bg-white/15 rounded-xl border border-white/20 border-dashed transition-all duration-150 backdrop-blur-sm"
						>
					...
					{error && (
						<motion.span
							...
							className="bg-red-500/10 w-full rounded-lg max-w-xl text-center text-balance p-2 text-xs text-neutral-300 backdrop-blur-sm"
						>
							{error}
						</motion.span>
					)}
					{success && (
						<motion.button
							...
							className="px-4 bg-white text-black font-medium py-1 rounded-full text-sm active:scale-[0.97] cursor-pointer"
						>
