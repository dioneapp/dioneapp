...
import { Theme, applyTheme, getStoredBackgroundIntensity, getStoredTheme, setBackgroundIntensity, themes } from "@/utils/theme";
...
export default function ThemeSelector() {
	...
	const [isIntense, setIsIntense] = useState<boolean>(getStoredBackgroundIntensity() === 'intense');
