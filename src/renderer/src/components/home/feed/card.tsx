	...
	return (
		<div ref={innerRef}>
			<Link
				...
				bg-linear-to-r from-[#BCB1E7]/5 to-[#080808]/10 hover:from-[#BCB1E7]/10 hover:to-[#080808]/20 transition-colors duration-300 rounded-lg p-4 hover:shadow-lg items-center relative"
			>
