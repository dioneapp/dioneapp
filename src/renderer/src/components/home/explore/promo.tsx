	...
	return (
		<div className="mt-6 w-full rounded-xl border border-white/5 bg-[#080808]/50 overflow-hidden">
			<div className="relative w-full p-4">
				{/* background effects */}
			<div className="absolute top-0 left-1/4 md:left-1/3 w-32 h-32 md:w-64 md:h-64 rounded-full -translate-y-1/2 blur-3xl md:blur-[100px] animate-pulse [animation-duration:7000ms]" style={{ backgroundColor: 'var(--theme-blur)' }} />
			<div className="absolute bottom-0 right-1/4 md:right-1/3 w-32 h-32 md:w-64 md:h-64 rounded-full translate-y-1/2 blur-3xl md:blur-[100px] animate-pulse [animation-duration:7000ms]" style={{ backgroundColor: 'var(--theme-blur)' }} />
