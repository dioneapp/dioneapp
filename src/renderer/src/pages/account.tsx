					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 h-full">
							...
							<div className="flex flex-col items-start overflow-hidden rounded-lg h-full">
								<span className="flex flex-col items-start gap-0.5 w-full mb-6">
									<div className="flex items-center justify-between w-full">
										<h3 className="z-10 text-2xl font-medium text-white w-full">Time spent</h3>
										<Icon name="Time" className="w-6 h-6 opacity-80" />
									</div>
									<h5 className="z-10 text-xs font-medium text-neutral-400">in last 7 days</h5>
								</span>
								<h4 className="z-10 text-3xl font-medium text-white flex justify-end mt-auto">{formatTimeSpent(hoursInApp)}</h4>
							</div>
						</div>
						<div className="col-span-2 sm:col-span-1 md:col-span-2 bg-white/10 rounded-xl p-8 h-auto flex flex-col">
							<div className="group relative flex flex-col items-start overflow-hidden rounded-lg ">
								<span className="flex flex-col items-start gap-0.5 w-full mb-6">
									<div className="flex items-center justify-between w-full">
										<h3 className="z-10 text-2xl font-medium text-white w-full">Sessions</h3>
										<Icon name="Sessions" className="w-6 h-6 opacity-80" />
									</div>
									<h5 className="z-10 text-xs font-medium text-neutral-400">in last 7 days</h5>
								</span>
								<h4 className="z-10 text-3xl font-medium text-white">{data.sessions.length}</h4>
							</div>
						</div>
						<div className="col-span-2 sm:col-span-1 md:col-span-2 bg-white/10 rounded-xl p-8 h-auto flex flex-col">
							<div className="group relative flex flex-col items-start overflow-hidden rounded-lg ">
								<span className="flex flex-col items-start gap-0.5 w-full mb-6">
									<div className="flex items-center justify-between w-full">
										<h3 className="z-10 text-2xl font-medium text-white w-full">Events</h3>
										<Icon name="Events" className="w-6 h-6 opacity-80" />
									</div>
									<h5 className="z-10 text-xs font-medium text-neutral-400">in last 7 days</h5>
								</span>
								<h4 className="z-10 text-3xl font-medium text-white">{data.total}</h4>
							</div>
						</div>
						<div className="group relative col-span-2 sm:col-span-1 md:col-span-full bg-white/10 rounded-xl p-8 h-auto flex flex-col">
							...
							<div className="group relative flex flex-col items-start overflow-hidden">
								<span className="flex flex-col items-start gap-0.5 w-full mb-6">
									<div className="flex items-center justify-between w-full">
										<h3 className="z-10 text-2xl font-medium text-white w-full">Streak</h3>
										<Icon name="Streak" className="w-6 h-6 opacity-80" />
									</div>
									<h5 className="z-10 text-xs font-medium text-neutral-400">consecutive days</h5>
								</span>
								<span className="flex items-end gap-1 mb-3">
									<h4 className="z-10 text-3xl font-medium text-white">{consecutiveDays}</h4>
									<h5 className="z-10 text-xs font-medium text-neutral-400 pb-1">days</h5>
								</span>
