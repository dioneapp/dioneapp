export const hi = {
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"धीमा करें! आपके पास पहले से ही 6 ऐप एक ही समय में चल रहे हैं।",
			},
		},
	},
	...
	settings: {
		applications: {
			...
			cleanUninstall: {
				...
				description:
					"एप्लिकेशन को अनइंस्टॉल करते समय सभी संबंधित निर्भरताओं को हटा दें",
			},
		},
		interface: {
			title: "इंटरफ़ेस",
	...
	report: {
		...
		description:
			"कृपया बताएं कि क्या हुआ और आप क्या करने की कोशिश कर रहे थे।",
		placeholder:
