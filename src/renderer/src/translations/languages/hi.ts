export const en = {
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"धीमे चलें! आपके पास पहले से ही एक साथ 6 ऐप चल रहे हैं।",
			},
		},
	},
	...
	titlebar: {
		closing: {
			...
			description:
				"सभी खुले एप्लिकेशन बंद करने के बाद Dione स्वतः बंद हो जाएगा।",
		},
	},
	...
	settings: {
		applications: {
			...
			binDirectory: {
				...
				description:
					"आसान पहुंच के लिए एप्लिकेशन बाइनरी कहाँ संग्रहीत किए जाएंगे, चुनें",
			},
			cleanUninstall: {
			...
			autoOpenAfterInstall: {
				...
				description:
					"इंस्टॉलेशन के बाद पहली बार एप्लिकेशन स्वतः खोलें",
			},
			deleteCache: {
				label: "कैश हटाएं",
