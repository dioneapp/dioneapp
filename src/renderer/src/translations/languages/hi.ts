	...
	settings: {
		applications: {
			...
			installationDirectory: {
				...
				description:
					"चुनें कि नए एप्लिकेशन डिफ़ॉल्ट रूप से कहाँ इंस्टॉल किए जाएंगे",
			},
			binDirectory: {
				label: "बिन डायरेक्टरी",
				description:
					"एप्लिकेशन बाइनरी को आसान पहुंच के लिए कहाँ संग्रहीत किया जाएगा",
			},
			cleanUninstall: {
				label: "क्लीन अनइंस्टॉल",
				description:
					"एप्लिकेशन अनइंस्टॉल करते समय सभी संबंधित डिपेंडेंसी हटा दें",
			},
			autoOpenAfterInstall: {
				label: "इंस्टॉल के बाद ऑटो-ओपन",
				description:
					"इंस्टॉलेशन के बाद पहली बार एप्लिकेशन को स्वचालित रूप से खोलें",
			},
			deleteCache: {
				label: "कैश हटाएं",
