	...
	settings: {
		...
		other: {
			...
			disableAutoUpdate: {
				...
				description: "स्वचालित अपडेट्स को अक्षम करता है। सावधान रहें: आपका ऐप महत्वपूर्ण सुधार या सुरक्षा पैच मिस कर सकता है। अधिकांश उपयोगकर्ताओं के लिए यह विकल्प अनुशंसित नहीं है।",
			},
			logsDirectory: {
