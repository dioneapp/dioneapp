	...
	settings: {
		...
		other: {
			...
			disableAutoUpdate: {
				...
				description:
					"স্বয়ংক্রিয় আপডেট বন্ধ করে। সতর্কতা: আপনার অ্যাপটি গুরুত্বপূর্ণ ফিক্স বা নিরাপত্তা প্যাচ মিস করতে পারে। বেশিরভাগ ব্যবহারকারীর জন্য এই বিকল্পটি সুপারিশ করা হয় না।",
			},
			logsDirectory: {
				label: "লগস ডিরেক্টরি",
