export const bn = {
	...
	settings: {
		applications: {
			...
			binDirectory: {
				label: "বাইনারি ডিরেক্টরি",
				description:
					"অ্যাপ্লিকেশন বাইনারিগুলি সহজ অ্যাক্সেসের জন্য কোথায় সংরক্ষণ করা হবে তা চয়ন করুন",
			},
			cleanUninstall: {
			...
			autoOpenAfterInstall: {
				...
				description: "ইনস্টলেশনের পর প্রথমবার অ্যাপ্লিকেশন স্বয়ংক্রিয়ভাবে খুলুন",
			},
			deleteCache: {
				label: "ক্যাশে মুছুন",
		...
		other: {
			...
			disableAutoUpdate: {
				...
				description: "স্বয়ংক্রিয় আপডেট বন্ধ করে। সতর্কতা: আপনার অ্যাপটি গুরুত্বপূর্ণ ফিক্স বা নিরাপত্তা প্যাচ মিস করতে পারে। বেশিরভাগ ব্যবহারকারীর জন্য এই বিকল্পটি সুপারিশ করা হয় না।",
			},
			logsDirectory: {
				label: "লগ ডিরেক্টরি",
