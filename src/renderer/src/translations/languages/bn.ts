export const bn = {
	...
	firstTime: {
		...
		clipboard: {
			success:
				"সঠিকভাবে ক্লিপবোর্ডে কপি করা হয়েছে, এখন আপনার ব্রাউজারে পেস্ট করুন!",
		},
	},
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"ধীরে! আপনি ইতিমধ্যেই একই সময়ে 6টি অ্যাপ চালাচ্ছেন।",
			},
		},
	},
	...
	settings: {
		...
		interface: {
			...
			compactView: {
				label: "কমপ্যাক্ট ভিউ",
				description:
					"স্ক্রিনে আরও বিষয়বস্তু ফিট করার জন্য আরও ঘন বিন্যাস ব্যবহার করুন",
			},
		},
		notifications: {
			title: "বিজ্ঞপ্তি",
	...
	quickLaunch: {
		...
		selectApp: {
			...
			description: "{count}টি অ্যাপ উপলব্ধ। আপনি সর্বোচ্চ {max}টি নির্বাচন করতে পারবেন।",
		},
	},
