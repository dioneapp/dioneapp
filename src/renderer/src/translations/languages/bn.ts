export const bn = {
	...
	firstTime: {
		...
		clipboard: {
			success:
				"সফলভাবে ক্লিপবোর্ডে কপি করা হয়েছে, এখন আপনার ব্রাউজারে পেস্ট করুন!",
		},
		selectPath: {
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"ধীরে চলুন! আপনার একই সাথে ৬টি অ্যাপ চলছে।",
			},
		},
	},
	...
	settings: {
		applications: {
			...
			autoOpenAfterInstall: {
				...
				description:
					"ইনস্টলেশনের পরে প্রথমবারের মতো অ্যাপ্লিকেশনগুলি স্বয়ংক্রিয়ভাবে খুলুন",
			},
			deleteCache: {
				label: "ক্যাশ মুছুন",
