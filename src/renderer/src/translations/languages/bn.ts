export const bn = {
	...
	firstTime: {
		...
		clipboard: {
			success:
				"সঠিকভাবে ক্লিপবোর্ডে অনুলিপি করা হয়েছে, এখন আপনার ব্রাউজারে পেস্ট করুন!",
		},
		selectPath: {
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"ধীর করুন! আপনি একই সময়ে ইতিমধ্যেই ৬টি অ্যাপ চালাচ্ছেন।",
			},
		},
	},
	...
	settings: {
		applications: {
			...
			installationDirectory: {
				...
				description:
					"নতুন অ্যাপ্লিকেশনগুলি ডিফল্টভাবে কোথায় ইনস্টল করা হবে তা চয়ন করুন",
			},
			binDirectory: {
				label: "বিন ডিরেক্টরি",
				description:
			...
			cleanUninstall: {
				...
				description:
					"অ্যাপ্লিকেশন আনইনস্টল করার সময় সমস্ত সম্পর্কিত নির্ভরতাগুলি সরান",
			},
			autoOpenAfterInstall: {
				label: "ইনস্টলের পরে স্বয়ংক্রিয়ভাবে খুলুন",
				description:
					"ইনস্টলেশনের পরে প্রথমবারের জন্য অ্যাপ্লিকেশনগুলি স্বয়ংক্রিয়ভাবে খুলুন",
			},
			deleteCache: {
				label: "ক্যাশ মুছুন",
