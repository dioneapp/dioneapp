export const ar = {
	...
	error: {
		...
		description:
			"لقد اكتشفنا خطأ غير متوقع في التطبيق، نعتذر عن أي إزعاج.",
		return: "رجوع",
		report: {
			toTeam: "إبلاغ الفريق",
	...
	settings: {
		...
		privacy: {
			...
			errorReporting: {
				...
				description: "المساعدة في تحسين Dione عن طريق إرسال تقارير أخطاء مجهولة",
			},
		},
		other: {
			title: "أخرى",
	...
	quickLaunch: {
		...
		selectApp: {
			title: "اختر تطبيقًا",
			description: "التطبيقات المتاحة هي {count}. يمكنك اختيار ما يصل إلى {max}.",
		},
	},
