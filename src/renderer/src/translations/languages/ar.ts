export const ar = {
	...
	firstTime: {
		...
		clipboard: {
			success:
				"تم النسخ إلى الحافظة بشكل صحيح، الصقه الآن في متصفحك!",
		},
	},
	...
	error: {
		...
		description:
			"لقد اكتشفنا خطأ غير متوقع في التطبيق، نأسف للإزعاج.",
		return: "عودة",
		report: {
			toTeam: "إبلاغ الفريق",
	...
	toast: {
		...
		install: {
			...
			error: {
				...
				tooManyApps:
					"ابطئ! لديك بالفعل 6 تطبيقات تعمل في نفس الوقت.",
			},
		},
	},
	...
	settings: {
		...
		privacy: {
			...
			errorReporting: {
				...
				description: "ساعد في تحسين Dione عن طريق إرسال تقارير أخطاء مجهولة الهوية",
			},
		},
		other: {
			title: "أخرى",
	...
	report: {
		...
		disclaimer:
			"سيتم تضمين معلومات النظام التالية ومعرف مجهول في تقريرك.",
