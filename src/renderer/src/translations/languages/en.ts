export const en = {
  ...
  noAccess: {
    ...
    description: "Dione is under construction and only a limited amount of users can access it, join our whitelist now to get access to future versions of our app.",
    join: "Join",
    logout: "Logout"
  },
  ...
  firstTime: {
    welcome: {
      title: "Welcome to",
      subtitle: "Thank you for joining us early on this journey. Log into your account to get started.",
      login: "Log in",
      copyLink: "Copy Link"
    },
    loggingIn: {
    ...
    clipboard: {
      success: "Copied to the clipboard correctly, now paste it in your browser!"
    }
  },
  ...
  error: {
    ...
    description: "We have detected an unexpected error in the application, we are sorry for the inconvenience.",
    return: "Return",
    report: {
  ...
  titlebar: {
    closing: {
      ...
      description: "Dione will close automatically after closing all open applications."
    }
  },
  ...
  sidebar: {
    ...
    update: {
      ...
      description: "A new version of Dione is available, please restart the app to update.",
  ...
  settings: {
    applications: {
      ...
      installationDirectory: {
        ...
        description: "Choose where new applications will be installed by default"
      },
      cleanUninstall: {
        label: "Clean Uninstall",
        description: "Remove all related dependencies when uninstalling applications"
      }
    },
    interface: {
      title: "Interface",
      ...
      compactView: {
        label: "Compact View",
        description: "Use a more condensed layout to fit more content on screen"
      }
    },
    notifications: {
      title: "Notifications",
    ...
    other: {
      ...
      showOnboarding: {
        ...
        description: "Reset Dione to its initial state and show again the onboarding for reconfiguration",
        button: "Reset"
      }
    }
  },
  ...
  report: {
    ...
    description: "Please provide details about what happened and what you were trying to do.",
    ...
    disclaimer: "The following system information and an anonymous ID will be included with your report.",
  ...
  logs: {
    loading: "Loading...",
    disclaimer: "Logs shown are from the app itself. If you see an error, please report it to the original app's developers first.",
    status: {
      success: "Success",
      error: "Error",
      pending: "Pending"
