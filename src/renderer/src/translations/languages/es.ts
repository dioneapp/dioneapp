export const es = {
	...
	settings: {
		applications: {
			...
			binDirectory: {
				...
				description:
					"Elige dónde se almacenarán los binarios de las aplicaciones para fácil acceso",
			},
			cleanUninstall: {
		...
		notifications: {
			...
			installationAlerts: {
				...
				description:
					"Recibe notificaciones cuando se completen las instalaciones de aplicaciones",
			},
			discordRPC: {
	...
	quickLaunch: {
		...
		tooltips: {
			noMoreApps: "No hay apps disponibles para añadir",
		},
		selectApp: {
