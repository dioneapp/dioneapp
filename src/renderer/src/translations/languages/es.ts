export const es = {
  ...
  noAccess: {
    ...
    description: "Dione está en construcción y solo un número limitado de usuarios puede acceder. Únete a nuestra lista blanca ahora para obtener acceso a futuras versiones de nuestra aplicación.",
    join: "Unirse",
  ...
  firstTime: {
    welcome: {
      title: "Bienvenido a",
      subtitle: "Gracias por unirte a nosotros al principio de este viaje. Inicia sesión en tu cuenta para empezar.",
    ...
    clipboard: {
      success: "Copiado al portapapeles correctamente, ¡ahora pégalo en tu navegador!"
    }
  },
  ...
  error: {
    ...
    description: "Hemos detectado un error inesperado en la aplicación, lamentamos las molestias.",
    return: "Volver",
    report: {
  ...
  titlebar: {
    closing: {
      ...
      description: "Dione se cerrará automáticamente después de cerrar todas las aplicaciones abiertas."
    }
  },
  ...
  sidebar: {
    ...
    update: {
      ...
      description: "Una nueva versión de Dione está disponible, por favor reinicia la aplicación para actualizar.",
      tooltip: "Nueva actualización disponible, por favor reinicia Dione para actualizar."
    },
    tooltips: {
      library: "Biblioteca",
  ...
  settings: {
    applications: {
      ...
      installationDirectory: {
        ...
        description: "Elige dónde se instalarán las nuevas aplicaciones por defecto"
      },
      cleanUninstall: {
        label: "Desinstalación limpia",
        description: "Eliminar todas las dependencias relacionadas al desinstalar aplicaciones"
      }
    },
    interface: {
      title: "Interfaz",
      ...
      compactView: {
        ...
        description: "Usa un diseño más condensado para mostrar más contenido en pantalla"
      }
    },
    notifications: {
      ...
      systemNotifications: {
        ...
        description: "Mostrar notificaciones de escritorio para eventos importantes"
      },
      installationAlerts: {
        label: "Alertas de instalación",
        description: "Recibir notificaciones cuando se completen las instalaciones de aplicaciones"
      }
    },
    privacy: {
      title: "Privacidad",
    ...
    other: {
      ...
      submitFeedback: {
        ...
        description: "Reportar cualquier problema o inconveniente que encuentres",
        button: "Enviar informe"
      },
      showOnboarding: {
        label: "Mostrar bienvenida",
        description: "Restablece Dione a su estado inicial y muestra de nuevo la bienvenida para la reconfiguración",
        button: "Restablecer"
      }
    }
  },
  ...
  report: {
    ...
    description: "Por favor, proporciona detalles sobre lo que sucedió y lo que estabas intentando hacer.",
    placeholder: "Ejemplo: Estaba intentando instalar una aplicación cuando ocurrió este error...",
    systemInformationTitle: "Información del sistema",
    disclaimer: "La siguiente información del sistema y un ID anónimo se incluirán con tu informe.",
  ...
  logs: {
    loading: "Cargando...",
    disclaimer: "Los registros mostrados son de la propia aplicación. Si ves un error, por favor repórtalo primero a los desarrolladores de la aplicación original.",
    status: {
      success: "Éxito",
      error: "Error",
      pending: "Pendiente"
