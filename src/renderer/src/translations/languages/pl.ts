export const pl = {
    ...
    firstTime: {
        ...
        languageSelector: {
            ...
            error: {
                ...
                general:
                    "Wystąpił błąd podczas wybierania ścieżki. Spróbuj ponownie.",
            },
        ...
        clipboard: {
            success:
                "Skopiowano do schowka, teraz wklej to w przeglądarce!",
        },
        navigation: {
            back: "Wstecz",
        },
    ...
    toast: {
        ...
        install: {
            ...
            error: {
                ...
                tooManyApps:
                    "Zwolnij! Masz już uruchomione 6 aplikacji jednocześnie.",
            },
        },
    },
    ...
    sidebar: {
        ...
        update: {
            ...
            tooltip: "Dostępna nowa aktualizacja, uruchom ponownie Dione, aby zaktualizować.",
        },
        login: {
            ...
            waitingDescription:
                "Dokończ logowanie w przeglądarce aby kontynuować.",
            cancel: "Anuluj",
        },
        tooltips: {
            library: "Biblioteka",
    ...
    settings: {
        ...
        notifications: {
            ...
            installationAlerts: {
                ...
                description: "Otrzymuj powiadomienia po zakończeniu instalacji aplikacji.",
            },
            discordRPC: {
        ...
        privacy: {
            ...
            errorReporting: {
                ...
                description: "Pomóż ulepszyć Dione, wysyłając anonimowe raporty o błędach.",
            },
        },
        other: {
            title: "Inne",
    ...
    report: {
        ...
        sending: "Wysyłanie...",
        contribute: "Pomóż nam uczynić ten skrypt kompatybilnym ze wszystkimi urządzeniami",
    },
    ...
    quickLaunch: {
        ...
        selectApp: {
            ...
            description: "{count} aplikacji dostępnych. Możesz wybrać maksymalnie {max}.",
        },
    },
    ...
    installAI: {
        ...
        step3: {
            ...
            description: "Dio AI używa Ollama do pracy z modelami LLM w twoim systemie.",
    ...
    deleteLoading: {
        ...
        depsDescription:
            "Wybierz zależności do odinstalowania wraz z aplikacją:",
        uninstall: {
            title: "Odinstaluj",
        ...
        error: {
            ...
            general: "Spróbuj ponownie później lub sprawdź logi, aby uzyskać więcej informacji.",
        },
        loading: {
            title: "Ładowanie...",
            wait: "Proszę czekać...",
    ...
    networkShare: {
        ...
        local: {
            ...
            description: "Ten URL działa na urządzeniach podłączonych do tej samej sieci.",
        },
        public: {
    ...
    editor: {
        ...
        mediaNotSupported: "Podgląd dla tego typu multimediów nie jest jeszcze obsługiwany.",
    ...
    entryDialog: {
        ...
        currentLocationRoot: "Obecna lokalizacja: katalog główny obszaru roboczego.",
        rename: "Zmień nazwę",
