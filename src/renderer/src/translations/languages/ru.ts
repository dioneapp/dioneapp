export const ru = {
	...
	noAccess: {
		...
		description:
			"Dione находится в разработке, и доступ к нему имеют только ограниченное количество пользователей. Присоединяйтесь к нашему списку рассылки сейчас, чтобы получить доступ к будущим версиям нашего приложения.",
		join: "Присоединиться",
		logout: "Выйти",
	},
	...
	firstTime: {
		...
		ready: {
			title: "Вы готовы!",
			subtitle: "Мы рады вас видеть",
			finish: "Завершить",
		},
		clipboard: {
			success:
				"Скопировано в буфер обмена, теперь вставьте его в свой браузер!",
		},
		selectPath: {
	...
	toast: {
		...
		install: {
			...
			retrying: "Попытка установить %s снова...",
			success: {
				stopped: "%s успешно остановлен.",
				uninstalled: "%s успешно удален.",
				logsCopied: "Логи успешно скопированы в буфер обмена.",
	...
	sidebar: {
		...
		update: {
			...
			description:
				"Доступна новая версия Dione, перезапустите приложение для обновления.",
			tooltip: "Доступно новое обновление, перезапустите Dione для обновления.",
		},
		tooltips: {
			library: "Библиотека",
			settings: "Настройки",
	...
	settings: {
		applications: {
			...
			autoOpenAfterInstall: {
				...
				description:
					"Автоматически запускать приложения впервые после установки",
			},
			deleteCache: {
				label: "Удалить кеш",
		...
		interface: {
			...
			compactView: {
				...
				description:
					"Используйте более плотный макет, чтобы вместить больше контента на экране",
			},
		},
		notifications: {
			title: "Уведомления",
		...
		privacy: {
			...
			errorReporting: {
				...
				description: "Помогайте улучшать Dione, отправляя анонимные отчеты об ошибках",
			},
		},
		other: {
			title: "Прочее",
			disableAutoUpdate: {
				...
				description:
					"Отключает автоматические обновления. Внимание: ваше приложение может пропускать важные исправления или исправления безопасности. Эта опция не рекомендуется для большинства пользователей.",
			},
			logsDirectory: {
				label: "Каталог логов",
				description: "Расположение, где хранятся логи приложений",
			},
			submitFeedback: {
			...
			showOnboarding: {
				...
				description:
					"Сбросить Dione в исходное состояние и снова показать онбординг для переконфигурации",
				button: "Сбросить",
			},
			variables: {
				label: "Переменные",
	...
	missingDeps: {
		...
		logs: {
			...
			error: {
				...
				install: "❌ Ошибка при установке зависимостей: {error}",
			},
	...
	deleteLoading: {
		...
		success: {
			title: "Удалено",
			subtitle: "успешно",
			closing: "Закрытие этого окна через",
			seconds: "секунд...",
		},
		error: {
			...
			general: "Пожалуйста, попробуйте позже или проверьте логи для получения дополнительной информации.",
		},
		loading: {
			title: "Загрузка...",
			wait: "Пожалуйста, подождите...",
	...
	logs: {
		loading: "Загрузка...",
		disclaimer:
			"Показанные логи относятся к самому приложению. Если вы видите ошибку, пожалуйста, сначала сообщите о ней разработчикам оригинального приложения.",
		status: {
			success: "Успех",
			error: "Ошибка",
			pending: "В ожидании",
