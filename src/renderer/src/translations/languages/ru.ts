	...
	settings: {
		...
		other: {
			...
			disableAutoUpdate: {
				...
				description:
					"Отключает автоматические обновления. Внимание: ваше приложение может пропустить важные исправления или патчи безопасности. Эта опция не рекомендуется для большинства пользователей.",
			},
			logsDirectory: {
