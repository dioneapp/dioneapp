export const ru = {
	...
	sidebar: {
		...
		update: {
			...
			tooltip: "Доступно новое обновление, перезапустите Dione, чтобы обновиться.",
		},
		tooltips: {
			library: "Библиотека",
			settings: "Настройки",
	...
	settings: {
		...
		other: {
			...
			submitFeedback: {
				...
				description: "Сообщайте о любых проблемах или неполадках, с которыми вы сталкиваетесь",
